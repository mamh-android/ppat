    ...
    init = function()
        if(app.xsi == 1) then
            ...
            if(config.show_intro) then
                ...
                app.load_fms(game_tests[3].fms_file)
            end
        end
    end;
...
advanced_world_params = 
{
    ...
    -- Shader paths
    vertex_shader   = "shaders/adv_world.vert";
    fragment_shader = "shaders/adv_world.frag";
}
...
batch_params =
{
    ...
    shaderParameters = 
    {
        -- 0  - texture mapping
        {
            ...
            vertex_shader   = "shaders/batchtest00.vert";
            fragment_shader = "shaders/batchtest00.frag";
        };

        -- 1  - texture mapping + vertex colors
        {
            texDiffuse      = "Pictures/fm_logo.png";
            vertex_shader   = "shaders/batchtest01.vert";
            fragment_shader = "shaders/batchtest01.frag";
        };

        -- 2  - vertex colors
        {
            vertex_shader   = "shaders/batchtest02.vert";
            fragment_shader = "shaders/batchtest02.frag";
        };
        ...
        -- 3  - texture mapping + texture transform
        {
            ...
            velScale        = 0.3;
            dScale          = 3.0;
            vertex_shader   = "shaders/batchtest03.vert";
            fragment_shader = "shaders/batchtest03.frag";
        };
        ...
        -- 4  - texture mapping + vertex colors + texture transform
        {
            ...
            velScale        = 0.3;
            dScale          = 3.0;
            vertex_shader   = "shaders/batchtest04.vert";
            fragment_shader = "shaders/batchtest04.frag";
        };

        -- 5  - no texture, single color
        {
            vertex_shader   = "shaders/batchtest05.vert";
            fragment_shader = "shaders/batchtest05.frag";
        };

        -- 6  - alpha texturing
        {
            texDiffuse      = "Pictures/noise2_ts.png";
            vertex_shader   = "shaders/batchtest06.vert";
            fragment_shader = "shaders/batchtest06.frag";
        };

        -- 7  - alpha texturing + vertex colors
        {
            texDiffuse      = "Pictures/noise2_ts.png";
            vertex_shader   = "shaders/batchtest07.vert";
            fragment_shader = "shaders/batchtest07.frag";
        };

        -- 8  - noise
        {
            texDiffuse      = "Pictures/noise2_ts.png";
            vertex_shader   = "shaders/batchtest08.vert";
            fragment_shader = "shaders/batchtest08.frag";
        };
    };
}
...
texture_filtering = 
{
    ...
    vertex_shader       = "shaders/texturefiltertest.vert";
    fragment_shader     = "shaders/texturefiltertest.frag";
    texture_filter      = 0;
    color_mipmaps       = 0;
}
...
unified_shader_params = 
{
    ...
    vertex_shader   = "shaders/unified_shader.vert";
    fragment_shader = "shaders/unified_shader2.frag";
...
post_process_params = 
{
    ...
    vertex_shader	= "shaders/1_Tex.vert";
    fragment_shader	= "shaders/1_Tex.frag";
    
    -- Gaussian blur shaders, HVBlur is combined version of HBlur & VBlur
    blur_vertex_shader    = "shaders/1_Mirror_Tex.vert";
    blur_fragment_shader  = "shaders/HVBlur.frag";
    -- blur_fragment_shader = "shaders/HBlur.frag";
    -- blur_fragment_shader = "shaders/VBlur.frag";

    -- Combine shader, combines two textures
    combine_vertex_shader   = "shaders/1_Mirror_Tex.vert";
    combine_fragment_shader = "shaders/combine.frag";
    
    -- Star glow shader, creates stars to bright spots in image
    star_glow_vertex_shader     = "shaders/1_Mirror_Tex.vert";
    star_glow_fragment_shader   = "shaders/StarGlow.frag";
